...
for k = 1 : 1 : 10 
    ...
    t = 1:1:200;
    legdText{k} = ['K=', num2str(K)];
    K = K + 5;
    plot(t,ze);
    hold on
end
% legend(legdText{1}, legdText{2}, legdText{3}, legdText{4}, legdText{5}, legdText{6} ...
%     , legdText{7}, legdText{8}, legdText{9}, legdText{10});
legend(legdText);
% view(3);
% robot.plot(qq)
% robot.teach